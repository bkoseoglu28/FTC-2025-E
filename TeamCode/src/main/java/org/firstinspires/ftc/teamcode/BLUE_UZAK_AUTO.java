...
@Autonomous(name = "BLUE UZAK AUTO")
public class BLUE_UZAK_AUTO extends OpMode {

    private Follower follower;
    private Timer pathTimer, actionTimer, opmodeTimer;
    private int pathState;

    private final Pose startPose = new Pose(56.60, 9.30, Math.toRadians(90));
    private final Pose scorePose = new Pose(63.50, 31.50, Math.toRadians(90));
    private final Pose pickUp1Pose = new Pose(24.00, 36.00, Math.toRadians(180));
